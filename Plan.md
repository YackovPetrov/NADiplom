...
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
...
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3450`.
4. В поле `Месяц` ввести данные `09`.
5. В поле `Год` ввести данные `24`.
6. В поле `Владелец` ввести данные `Petrov Yakov`.
7. В поле `CVC/CVV` ввести данные `123`.
...
#### №10 Покупка тура с банковской карты с именем на кириллице":
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
4. В поле `Месяц` ввести данные `09`.
...
#### №11 Покупка в кредит тура с банковской карты с именем на кириллице":
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить в кредит`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
4. В поле `Месяц` ввести данные `09`.
...
#### №12 Покупка тура с активной банковской карты с некорректным кодом `CVC/CVV`:
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
4. В поле `Месяц` ввести данные `09`.
...
#### №13 Покупка тура в кредит с активной банковской карты с некорректным кодом `CVC/CVV`:
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить в кредит`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
4. В поле `Месяц` ввести данные `09`.
...
#### №14 Покупка тура с активной банковской карты без заполнения поля `Владелец`:
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
4. В поле `Месяц` ввести данные `09`.
...
#### №15 Покупка тура в кредит с активной банковской карты без заполнения поля `Владелец`:
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить в кредит`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
4. В поле `Месяц` ввести данные `09`.
...
#### №16 Покупка тура с активной банковской карты без заполнения поля `Месяц`:
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
...
#### №17 Покупка тура в кредит с активной банковской карты без заполнения поля `Месяц`:
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить в кредит`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
4. Поле `Месяц` оставить незаполненным.
...
#### №18 Покупка тура с банковской карты с именем на арабском":
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
4. В поле `Месяц` ввести данные `09`.
...
#### №19 Покупка тура в кредит с банковской карты с именем на арабском":
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
4. В поле `Месяц` ввести данные `09`.
...
#### №20 Покупка тура с банковской карты с именем китайскими иероглифами":
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
4. В поле `Месяц` ввести данные `09`.
...
#### №21 Покупка тура в кредит с банковской карты с именем китайскими иероглифами":
1. В браузере открыть http://localhost:8080/.
2. Нажать на кнопку `Купить`.
3. В поле `Номер карты` ввести данные `1234 5678 9012 3456`.
4. В поле `Месяц` ввести данные `09`.
